      ...
      <div className="lg:h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-y-12 my-10 px-1 md:px-10">
          <div className="shadow-xl border-l-4 border-primary rounded-lg relative p-4 order-1 my-8 md:my-0">
              ...
              <span>Role</span>
              {
                userInfo?.email === "toufiqhasankiron2@gmail.com" ? (
                  ...
                  <>
                    {
                      userInfo?.role === "donor" ? (
                        <span className="badge badge-error badge-xs p-3 select-none text-white">
                          Donor
                        </span>
            ...
            <hr className="border-dashed" />
            <div className="flex flex-col md:flex-row md:justify-between text-center md:text-right items-center px-4 mb-4 text-white">
              <span>Address</span>
