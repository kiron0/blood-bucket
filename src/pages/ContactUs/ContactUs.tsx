...
export default function ContactUs() {
          ...
          const handleContactForm = (e: any) => {
                    ...
                    if (!name || !email) return Swal.fire({
                              icon: "error",
                              title: "Oops...",
          ...
          return (
                    <section>
                              ...
                              <div className='container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 my-12 glass shadow-xl rounded-xl px-8 py-12 md:p-20'>
                                        <div className="w-full px-2 md:px-8 mx-auto py-4 order-1 lg:order-0">
                                        ...
                                        <div className='w-full px-2 md:w-2/3 md:px-8 mx-auto py-4 text-center rounded-none bg-secondary order-0 lg:order-1'>
                                                  <div className='flex flex-col justify-center items-center text-white'>
                                                            ...
                                                            <p className='text-lg border-b py-6 w-full'>Bogura, Bangladesh</p>

                                                            <p className='text-lg border-b py-6 w-full'>support@bloodbucket.com</p>
